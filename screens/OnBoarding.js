    ...
    <View style={styles.container}>
      <Onboarding
        ...
        pages={[
            ...
            title: <Animated.Text entering={FadeInUp.delay(200).duration(1000).springify()} style={{ fontSize: 30, fontWeight: '800',color:'black' }}>Work-Life Balance</Animated.Text>,
            subtitle: <Animated.Text style={{marginTop:10,fontSize:16}} entering={FadeInDown.delay(300).duration(1000).springify()}>We Value Work Life Balance</Animated.Text>,
          },
            
            {
              backgroundColor: '#e9fce6',
            image: <Animated.View style={styles.imageMiddleView}  entering={FadeInDown.delay(200).duration(1000).springify()}>
